  ...
  return (
    <div className="absolute top-5 left-2.5 w-[30%] h-1/4 border-4 border-red-500 bg-gradient-to-br from-gray-900 to-black md:flex md:items-center md:justify-center hidden shadow-2xl shadow-red-500/50 rounded-xl overflow-hidden group">
      ...
      <div className="text-center relative z-10">
        <h1 className="text-5xl xl:text-7xl font-black italic mt-4 bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 text-transparent bg-clip-text">R'tacos</h1>
        <p className="text-2xl xl:text-4xl mt-2 text-white font-bold tracking-wider">Birkhadem</p>
      </div>
    </div>
  )
}
